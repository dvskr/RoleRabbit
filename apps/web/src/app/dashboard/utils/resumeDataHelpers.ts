...
export function mergeTailoredResume(
  ...
  const merged: ResumeData = {
    ...
    linkedin: chooseContactValue(tailoredData.linkedin, baseData.linkedin),
    github: chooseContactValue(tailoredData.github, baseData.github),
    website: chooseContactValue(tailoredData.website, baseData.website),
