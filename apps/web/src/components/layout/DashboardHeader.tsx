  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        {/* Unified Theme Toggle - Primary Control */}
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg" style={{ background: colors.inputBackground, border: `1px solid ${colors.border}` }}>
