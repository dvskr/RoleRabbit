...
import { TrendingUp, Mail, Send, Inbox, Reply, Clock, CheckCircle, X } from 'lucide-react';
  ...
  return (
    <>
      <button
        ...
        aria-label="Close email analytics"
      />
      <div className="fixed inset-0 z-[51] flex items-center justify-center p-4">
        <div 
          className="rounded-2xl p-6 w-full max-w-6xl max-h-[90vh] overflow-y-auto shadow-2xl" 
          style={{ 
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 id="email-analytics-title" className="text-xl font-semibold" style={{ color: colors.primaryText }}>Email Effectiveness</h3>
